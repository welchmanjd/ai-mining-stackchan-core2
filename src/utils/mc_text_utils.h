...
#include <Arduino.h>
// Clamp to maxBytes without breaking UTF-8 sequences.
// If s is already <= maxBytes, returns s as-is.
...
// Convenience for logs: mcUtf8ClampBytes(mcSanitizeOneLine(s), maxBytes)
