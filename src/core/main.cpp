...
// 画面関連の定数
static const uint8_t  kDisplayActiveBrightness = 128;     // 通常時の明るさ


// スリープ前の「Zzz…」表示時間 [ms]
static const uint32_t kDisplaySleepMessageMs  = 5000UL;  // ここを変えれば好きな秒数に


// ---- TTS中のマイニング制御（安全側） ----
static int g_baseThreads = -1;      // 通常時のthreadsを記憶
